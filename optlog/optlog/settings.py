"""
Django settings for optlog project.
...
SECRET_KEY = 'django-insecure-ooamfw=#d048bb$3z0!djkg*-w@$zriiwhmj232_qb!ijasd)-'
...
WSGI_APPLICATION = 'optlog.wsgi.application'
